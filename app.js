...
function saveGoal(){
  ...
  selectedIcon='✈️';
  document.querySelectorAll('.icon-pick-btn').forEach(function(b,i){
    b.style.background=i===0?'#FFF0F1':'#F5F5F5';
    b.style.border=i===0?'1.5px solid #E30613':'1.5px solid transparent';
  });
